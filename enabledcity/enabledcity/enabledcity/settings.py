"""
Django settings for enabledcity project.
...
ROOT_URLCONF = 'enabledcity.urls'

WSGI_APPLICATION = 'enabledcity.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'enabledcity.sqlite3',                      # Or path to database file if using sqlite3.
